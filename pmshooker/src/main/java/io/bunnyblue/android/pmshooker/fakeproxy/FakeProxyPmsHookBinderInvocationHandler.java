...
/**opy from https://github.com/fourbrother/HookPmsSignature
 * Created by jiangwei1-g on 2016/9/7.
 */
public class FakeProxyPmsHookBinderInvocationHandler implements InvocationHandler{
    ...
    public FakeProxyPmsHookBinderInvocationHandler(Object base, String sign, int hashCode) {
        try {
            this.base = base;
            this.SIGN = sign;
