...
/**
 * Created by bunnyblue on 5/26/17.
 */
/*
 ...
 *
 * <li>A proxy class extends {@code FakeProxy}.
 *
 ...
 *
 * <li>The {@link FakeProxy#isProxyClass Proxy.isProxyClass} method will
 ...
 * can be also be created by calling the {@link FakeProxy#newProxyInstance
 * Proxy.newProxyInstance} method, which combines the actions of calling
 * {@link FakeProxy#getProxyClass Proxy.getProxyClass} with invoking the
 ...
 * {@link FakeProxy#getInvocationHandler Proxy.getInvocationHandler} method
 ...
 * @since       1.3
 */
public class FakeProxy implements java.io.Serializable {
    private static final long serialVersionUID = -2222568056686623797L;
    public static final Class<?>[] CLASS = new Class[0];
    /** prefix for all proxy class names */
    private final static String proxyClassNamePrefix = "$FakeProxy";
     ...
     */
    protected FakeProxy(InvocationHandler h) {
        this.h = h;
    }
...
//                                                 Class<?>[][] exceptions);
                Method generateProxy=null;
                try {
                     generateProxy= Proxy.class.getDeclaredMethod("generateProxy",String.class,Class[].class,ClassLoader.class
                    ,Method[] .class,Class[][].class);
                    generateProxy.setAccessible(true);
                    proxyClass=(Class) generateProxy.invoke(null,proxyName, interfaces, loader, methodsArray,
                            exceptionsArray);
...
//                        exceptionsArray);
    ...
    private static void validateReturnTypes(List<Method> methods) {
        ...
        for (Method method : methods) {
            Method equalNameAndParameters=null;
            try {
                equalNameAndParameters=Method.class.getDeclaredMethod("equalNameAndParameters",Method.class);
                equalNameAndParameters.setAccessible(true);
            } catch (NoSuchMethodException e) {
                e.printStackTrace();
            }
            try {
                if (vs == null || !(Boolean)(equalNameAndParameters.invoke(vs,method))) {
    ...
    private static List<Method> getMethods(Class<?>[] interfaces) {
        ...
        try {
            ...
            result.add(Object.class.getMethod("hashCode", CLASS));
            result.add(Object.class.getMethod("toString", CLASS));
        } catch (NoSuchMethodException e) {
            ...
            throws IllegalArgumentException
    {
         ...
         */
        if (!(proxy instanceof FakeProxy)) {
            throw new IllegalArgumentException("not a proxy instance");
        }
        return ((FakeProxy) proxy).h;
    }

    private static Object invoke(FakeProxy proxy, Method method, Object[] args) throws Throwable {
...
//                                                 Class<?>[][] exceptions);
    ...
    public static Comparator<Method> ORDER_BY_SIGNATURE(){
        try {
            Field field= Method.class.getDeclaredField("ORDER_BY_SIGNATURE");
            field.setAccessible(true);
            return (Comparator<Method>) field.get(null);
